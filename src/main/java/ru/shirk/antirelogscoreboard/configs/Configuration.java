...
public class Configuration {
    ...
    public Configuration(AntiRelogScoreboard plugin, String absolutePath) {
        this.config = null;
        this.file = null;
    ...
    public void reload() {
        ...
        if (!this.file.exists()) {
            ...
            AntiRelogScoreboard.getConfigurationManager().createFile(this.name);
        }
    ...
    public void save() {
        ...
        try {
            ...
            AntiRelogScoreboard.getInstance().getSLF4JLogger().info("Could not save config to {}", this.file, ex);
        }
    }
